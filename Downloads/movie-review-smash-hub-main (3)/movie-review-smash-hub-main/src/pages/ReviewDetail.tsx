...
import { ArrowLeft, ThumbsUp, MessageCircle, Share2, Star, Film, Sparkles, TrendingUp, TrendingDown, Eye } from "lucide-react";
          ...
          <Card className="relative bg-card border-2 border-primary shadow-[0_0_40px_rgba(255,215,0,0.4)] max-w-4xl mx-auto overflow-visible animate-fade-in mt-6">
            ...
            <CardContent className="space-y-6 px-4 sm:px-6">
              ...
              <div className="space-y-4">
                ...
                {/* Negatives */}
                <div className="rounded-xl p-[2px] bg-gradient-to-r from-orange-400 via-rose-400 to-pink-400 hover:shadow-[0_0_15px_rgba(251,113,133,0.3)] transition-all duration-300">
                  <div className="bg-card rounded-[10px] p-4">
                    <div className="flex items-center gap-2 mb-3">
