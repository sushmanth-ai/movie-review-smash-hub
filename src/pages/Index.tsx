...
const Index = () => {
  ...
  const handleCardClick = () => {
    const sound = new Audio('/sounds/card-click.wav');
    sound.currentTime = 0;
    sound.play();
  };
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-background">
        ...
        <div className="fixed top-0 left-0 w-full z-50 p-2 shadow-[0_4px_20px_rgba(255,215,0,0.3)] border-b-2 border-primary bg-background">
          <div className="flex justify-center items-center mb-2">
            <img
              ...
              alt="SM Reviews Logo"
              className="h-14 w-14 md:h-16 md:w-16 object-cover rounded-full border-2 border-yellow-400 shadow-[0_0_20px_rgba(255,215,0,0.6)]"
            />
        ...
        {/* ✅ Review Carousel (Stars Removed) */}
        <div className="container mx-auto px-4 pt-4">
          <ReviewCarousel reviews={filteredReviews.map(r => ({ ...r, rating: undefined }))} />
        </div>
        ...
        <div className="container mx-auto px-4 pt-0 pb-8">
          ...
          {newReviews.length > 0 && (
            <div className="mb-12">
              <h2 className="text-3xl font-bold text-primary mb-6 text-center">🎬 New Reviews</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {(showAllNewReviews ? newReviews : newReviews.slice(0, 3)).map((review) => (
                  <div key={review.id} id={`review-${review.id}`} onClick={handleCardClick}>
          ...
          {oldReviews.length > 0 && (
            <div className="mb-12">
              <h2 className="text-3xl font-bold text-primary mb-6 text-center">📽️ Old Reviews</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
