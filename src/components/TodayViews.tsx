...
export const TodayViews: React.FC<TodayViewsProps> = ({ viewCount }) => {
  return (
    <div className="max-w-md mx-auto mb-6">
      <Card className="bg-gradient-to-br from-black via-red-900 to-red-600 border-red-500/50 backdrop-blur-xl shadow-2xl hover:shadow-red-500/40 transition-all duration-700 hover:scale-110 hover:-rotate-2 relative overflow-hidden animate-pulse">
        <div className="absolute inset-0 bg-gradient-to-t from-red-600/20 via-transparent to-black/30"></div>
        <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-red-500 to-red-300 animate-pulse"></div>
        <CardContent className="relative flex items-center justify-center gap-5 p-8">
          <div className="bg-gradient-to-br from-red-500/40 to-black/60 p-5 rounded-full shadow-2xl backdrop-blur-md border border-red-400/30 hover:scale-110 transition-transform duration-300">
            <Eye className="h-8 w-8 text-red-300 drop-shadow-2xl animate-pulse" strokeWidth={2.5} />
          </div>
