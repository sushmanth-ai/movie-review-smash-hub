  ...
  return (
    <div className="fixed inset-0 z-[9999] pointer-events-none">
      <div className="curtain absolute inset-0 bg-gradient-to-b from-[#8b0000] to-[#b22222] origin-top animate-curtain-rise flex items-center justify-center">
        <h1 className="text-7xl md:text-9xl font-extrabold text-transparent bg-clip-text bg-gradient-to-b from-[#FFD700] via-[#FFA500] to-[#FF8C00] drop-shadow-[0_0_30px_rgba(255,215,0,0.8)] animate-pulse">
          SM REVIEWS
        </h1>
      </div>
    </div>
